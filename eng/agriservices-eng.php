...
<head>
    ...
    <title>Acrisure Agriservices S.r.l.</title>
...
<body>
    <header id="header">
        <div class="navbar">
            ...
            <nav class="language-switcher">
                <ul>
                    <li><a href="/agriservices.php" class="language-btn">IT</a></li>
    ...
    <section id="home" class="hero">
        <div class="hero-content">
            ...
            <p>Management of agricultural insurance portfolios and claims handling and settlement</p>
            ...
            <div class="news-container">
                <div class="news-card" data-index="0" onclick="window.location.href='#'">
                    ...
                    <div class="news-content">
                        ...
                        <p>Acrisure Agriculture announces a strategic collaboration with the leading national agricultural consortium to offer even more advantageous insurance policies.</p>
                    </div>
                </div>
    ...
    <section id="services" class="section">
        ...
        <div class="services-grid">
            ...
            <div class="service-row">
                <div class="service-card" style="width: 450px; height: 450px;">
                    <div class="service-image" style="height: 250px;">
                        <img src="/img/lcn.jpg" alt="Distributor Assistance">
                    </div>
                    <div class="service-content" style="padding: 2rem; text-align: center;">
                        <h3 style="font-size: 1.7rem; margin-bottom: 1.5rem;">DISTRIBUTOR ASSISTANCE</h3>
                        ...
                        <p style="color: #555; line-height: 1.6; font-size: 1.1rem;">
                            Operational and strategic support for the insurance distribution network
                        </p>
                    </div>
                </div>
                ...
                <div class="service-card" style="width: 450px; height: 450px;">
                    <div class="service-image" style="height: 250px;">
                        <img src="/img/servi3.avif" alt="Coverage Management">
                    </div>
                    <div class="service-content" style="padding: 2rem; text-align: center;">
                        <h3 style="font-size: 1.7rem; margin-bottom: 1.5rem;">COVERAGE MANAGEMENT</h3>
                        <div style="display: flex; justify-content: center;">
                            <div style="width: 60px; height: 4px; background-color: var(--accent); margin-bottom: 1.5rem;"></div>
                        </div>
                        <p style="color: #555; line-height: 1.6; font-size: 1.1rem;">
                            Analysis and administration of insurance coverage in the agricultural sector
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="service-row">
                <div class="service-card" style="width: 450px; height: 450px;">
                    <div class="service-image" style="height: 250px;">
                        <img src="/img/servi10.avif" alt="Claims Management">
                    </div>
                    <div class="service-content" style="padding: 2rem; text-align: center;">
                        ...
                        <p style="color: #555; line-height: 1.6; font-size: 1.1rem;">
                            Effective coordination of the entire claims management process
                        </p>
                    </div>
                </div>
                ...
                <div class="service-card" style="width: 450px; height: 450px;">
                    <div class="service-image" style="height: 250px;">
                        <img src="/img/servi14.avif" alt="Claims Settlement">
                    </div>
                    <div class="service-content" style="padding: 2rem; text-align: center;">
                        <h3 style="font-size: 1.7rem; margin-bottom: 1.5rem;">CLAIMS SETTLEMENT</h3>
                        <div style="display: flex; justify-content: center;">
                            <div style="width: 60px; height: 4px; background-color: var(--accent); margin-bottom: 1.5rem;"></div>
                        </div>
                        <p style="color: #555; line-height: 1.6; font-size: 1.1rem;">
                            Timeliness and transparency in the damage settlement phase
                        </p>
                    </div>
                </div>
            </div>
            ...
            <form id="contactForm">
                ...
                <div class="form-group">
                    ...
                    <select id="service" name="service" class="form-control" required>
                        ...
                        <option value="claim&services">Distributor Assistance</option>
                        <option value="gestione_sinistri">Insurance Coverage Management</option>
                        <option value="automotive_solution">Claims Opening and Management</option>
                        <option value="welfare">Claims Settlement</option>
