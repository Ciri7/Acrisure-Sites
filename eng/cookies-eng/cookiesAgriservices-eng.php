...
<head>
    ...
    <title>Acrisure Agriservices - Cookie Policy</title>
    ...
    <header id="header">
        <div class="navbar">
            ...
            <nav class="language-switcher">
                <ul>
                    <li><a href="/cookies/cookiesAgriservices.php" class="language-btn">IT</a></li>
