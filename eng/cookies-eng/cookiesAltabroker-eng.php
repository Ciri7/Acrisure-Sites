...
<body>
    ...
    <header id="header">
        <div class="navbar">
            ...
            <nav class="language-switcher">
                <ul>
                    <li><a href="/cookies/cookiesAltabroker.php" class="language-btn">IT</a></li>
    ...
    <div class="policy-container">
        ...
        <div class="policy-section">
            ...
            <p>These cookies are essential for the proper functioning of our Site and to allow you to browse and use its features. Without these cookies, some features of the Site might not be available.</p>
            <ul>
                <li><strong>Session cookies</strong>: are deleted when you close the browser and are necessary for the functioning of the site (e.g. maintaining the browsing session).</li>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>PHPSESSID</td>
                        <td>Technical</td>
                        <td>Maintains the user session state during navigation</td>
