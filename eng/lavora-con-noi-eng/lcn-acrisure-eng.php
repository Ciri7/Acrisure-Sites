...
<body>
        ...
        <div class="navbar">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="#header" class="nav-link">Work With Us</a></li>
                </ul>
            </nav>
            <nav class="language-switcher">
                <ul>
                    <li><a href="/lavora-con-noi/lcn-acrisure.php" class="language-btn">IT</a></li>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Work With Us</h1>
            <p>Join the Acrisure team and be part of a dynamic and growing reality in the insurance sector.</p>
            <a href="#open-positions" class="btn btn-secondary">Discover open positions</a>
        </div>
    </section>
            ...
            <div class="modal-body">
                ...
                <div class="gallery-container">
                    <div class="gallery-item">
                        <img src="/img/Nat&Avv.jpeg" alt="Nature & Adventure" class="gallery-image">
    ...
    <div id="modal-eventi" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="gallery-container">
                    <div class="gallery-item">
                        <img src="/img/cena di natale2.jpg" alt="Christmas Dinner" class="gallery-image">
                        <div class="gallery-caption">
    ...
    <section id="open-positions" class="section">
        ...
        <div class="careers-container">
            <div class="career-card">
                <div class="career-header">
                    ...
                    <div class="career-location">
                        <i class="fas fa-map-marker-alt"></i> Milan
                    </div>
                </div>
            ...
            <div class="career-card">
                <div class="career-header">
                    <h3 class="career-title">Claims Management Expert</h3>
                    <div class="career-location">
            ...
            <div class="career-card">
                <div class="career-header">
                    ...
                    <div class="career-location">
                        <i class="fas fa-map-marker-alt"></i> Turin
                    </div>
                </div>
                <div class="career-body">
                    <ul class="career-features">
                        <li>Operational management of company fleets</li>
                        <li>Coordination with suppliers and workshops</li>
                        <li>Cost monitoring and resource optimization</li>
            ...
            <div class="career-card">
                ...
                <div class="career-body">
                    <ul class="career-features">
                        ...
                        <li>Risk analysis and control implementation</li>
            ...
            <div class="career-card">
                <div class="career-header">
                    <h3 class="career-title">Software Developer</h3>
                    <div class="career-location">
                ...
                <div class="career-body">
                    <ul class="career-features">
                        <li>Development and maintenance of internal applications</li>
                        <li>Collaboration with the IT team</li>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <select id="position" name="position" class="form-control" required>
                            ...
                            <option value="Claims Management Expert">Claims Management Expert</option>
