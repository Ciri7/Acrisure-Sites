    ...
    <header id="header">
        <div class="navbar">
            ...
            <nav class="language-switcher">
                <ul>
                    <li><a href="/legal&comp/legalAgricolture.php" class="language-btn">IT</a></li>
    ...
    <section class="section">
        <div class="legal-content">
            <div class="legal-section">
                ...
                <p>Acrisure Agricolture S.r.l. operates in full compliance with current regulations, adopting the highest standards of governance and compliance. Our approach is based on transparency, integrity, and responsibility, ensuring adherence to all legal and regulatory provisions applicable to the insurance sector.</p>
            ...
            <div class="legal-section">
                ...
                <p>
                    ...
                    To this end, Acrisure Agricolture S.r.l. has implemented an internal reporting system governed by the Whistleblowing Procedure, developed in collaboration with trade union representatives, pursuant to Art. 51 of Legislative Decree 81/2015. This procedure establishes the methods for receiving and verifying reports, actively involving the Company, employees, and third parties.
                ...
                <ul>
                    <li><a href="../../DOCUMENTI/MODELLO 231/WB_Agricolture.pdf" target="_blank">Whistleblowing Procedure</a></li>
                </ul>
            </div>
        </div>
    </section>
