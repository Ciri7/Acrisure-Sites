    ...
    <section class="section">
        <div class="legal-content">
            <div class="legal-section">
                ...
                <div class="compliance-grid">
                    <div class="compliance-box">
                        ...
                        <p>We scrupulously comply with the provisions of IVASS (Institute for the Supervision of Insurance), guaranteeing maximum transparency in relations with customers and the correct management of insurance products.</p>
                    </div>
            ...
            <div class="legal-section">
                ...
                <p>In compliance with the legislation on the protection of whistleblowers (EU Directive 2019/1937 and Legislative Decree 24/2023), Acrisure Italy has established a dedicated channel for reporting violations or irregularities.</p>
                ...
                <p>We guarantee maximum confidentiality and protection against retaliation for whistleblowers who act in good faith.</p>
            </div>
        </div>
    </section>
