    ...
    <header id="header">
        <div class="navbar">
            ...
            <nav class="language-switcher">
                <ul>
                    <li><a href="/legal&comp/legalRe.php" class="language-btn">IT</a></li>
    ...
    <div class="legal-content">
        <div class="legal-section">
            ...
            <p>
                ...
                To this end, Acrisure Re Italia S.r.l. has implemented an internal reporting system governed by the Whistleblowing Procedure, developed in collaboration with trade union representatives, pursuant to Art. 51 of Legislative Decree 81/2015. This procedure establishes the methods for receiving and verifying reports, actively involving the Company, employees, and third parties.
            ...
            <ul>
                <li><a href="../../DOCUMENTI/MODELLO 231/WB_Re_Italia.pdf" target="_blank">Whistleblowing Procedure</a></li>
            </ul>
        </div>
    </div>
</section>
