    ...
    <header id="header">
        <div class="navbar">
            ...
            <nav class="language-switcher">
                <ul>
                    <li><a href="/news/newsAgricolture.php" class="language-btn">IT</a></li>
        ...
        <div class="news-grid">
            ...
            <article class="news-card">
                ...
                <div class="news-content">
                    ...
                    <p class="news-excerpt">Acrisure Agricolture announces a strategic collaboration with the main national agricultural consortium to offer even more advantageous policies.</p>
