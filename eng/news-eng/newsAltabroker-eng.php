    ...
    <header id="header">
        <div class="navbar">
            ...
            <nav class="language-switcher">
                <ul>
                    <li><a href="/news/newsAltabroker.php" class="language-btn">IT</a></li>
        ...
        <div class="news-grid">
            ...
            <article class="news-card">
                ...
                <div class="news-content">
                    ...
                    <p class="news-excerpt">Acrisure Agriculture announces a strategic collaboration with the national agricultural consortium to offer even more advantageous insurance policies.</p>
            ...
            <article class="news-card">
                ...
                <div class="news-content">
                    ...
                    <p class="news-excerpt">Over 200 participants at the event presenting news for 2024 and industry trends.</p>
