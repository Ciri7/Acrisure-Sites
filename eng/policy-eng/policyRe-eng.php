    ...
    <section class="section">
        <div class="privacy-content">
            <div class="privacy-section">
                <h2>PERSONAL DATA PROCESSING INFORMATION FOR THE WEBSITE</h2>
                <h3>INTRODUCTION</h3>
                <p>Pursuant to Regulation (EU) 2016/679 ("GDPR"), Acrisure Re Italia S.r.l. provides this information on the processing of personal data of users who browse the website <a href="/eng/re-eng.php">Acrisure Re Italia S.r.l.</a> and who provide their personal data to use the services offered therein.</p>
                ...
                <p>This policy applies to all users, including registered and unregistered visitors, of our site: <a href="/eng/re-eng.php">Acrisure Re Italia S.r.l.</a>. The user is invited to read this information carefully. In case of doubts or questions, the user can contact us at: <a href="mailto:acrisurereitalia@pec.it">acrisurereitalia@pec.it</a></p>
            </div>

            <div class="privacy-section">
                <h2>1) DATA CONTROLLER AND DATA PROTECTION OFFICER</h2>
                <p><strong>Data Controller</strong> is Acrisure Re Italia S.r.l., Via Mazzini 3, 07100, Sassari</p>
            ...
            <div class="privacy-section">
                ...
                <p>Acrisure Re Italia S.r.l. will process the following personal data of users:</p>
                ...
                <p>This category of data includes IP addresses or domain names of computers used by users connecting to the site, URI (Uniform Resource Identifier) addresses of requested resources, time of request, method used to submit the request to the server, and other parameters related to the user's operating system and computer environment as well as, regarding the use of connected services, the user's demographic data. For personal data processed through the use of cookies, please refer to the <a href="/eng/cookies-eng/cookiesRe-eng.php">relevant information</a>.</p>
                
                <h3>b) Data provided by the user</h3>
                <p>That is, all data that the user decides to share with Acrisure Re Italia S.r.l. to use the services available on the Website. In particular, to use the services offered on the Website, interested parties may provide:</p>
                <ul>
                    <li>Demographic and contact data (e.g., name, surname, email, telephone) provided through the "Contacts" section;</li>
                    ...
                    <li>Data present in messages sent to Acrisure Re Italia S.r.l. to request information.</li>
                </ul>
            </div>
                ...
                <table style="width:100%; border-collapse: collapse; margin: 20px 0;">
                    <thead>
                        <tr style="background-color: var(--secondary); color: white;">
                            <th style="border: 1px solid #ddd; padding: 8px;">TYPE OF DATA PROCESSED</th>
                            <th style="border: 1px solid #ddd; padding: 8px;">LEGAL BASIS</th>
                            <th style="border: 1px solid #ddd; padding: 8px;">PURPOSE OF PROCESSING</th>
                            <th style="border: 1px solid #ddd; padding: 8px;">RETENTION TIMES</th>
                            <th style="border: 1px solid #ddd; padding: 8px;">MANDATORY NATURE OF PROVISION</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td style="border: 1px solid #ddd; padding: 8px;">Please refer to what is reported in the <a href="/eng/cookies-eng/cookiesRe-eng.php">cookie information</a>.</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Please refer to what is reported in the <a href="/eng/cookies-eng/cookiesRe-eng.php">cookie information</a>.</td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>II.</strong> Demographic and contact data Data related to the asset to be insured</td>
                            ...
                            <td style="border: 1px solid #ddd; padding: 8px;">2 years from the service request and quote request (for prospects) 10 years from termination of the contractual relationship (for customers)</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Failure to provide data will make it impossible for Acrisure Re Italia S.r.l. to provide the requested services, but will not affect the user's use of the Website.</td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>III.</strong> Common personal data provided by the data subject, including those relating to addresses and contacts.</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Consent of the data subject (art. 6, par. 1, lett. a), GDPR)</td>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>MARKETING</strong> (for example only and not exhaustively: sending promotional communications, direct sales, targeting and re-targeting, conducting market research through automated and digital means e.g. SMS, Email, Instant Messaging Apps...)</td>
                            ...
                            <td style="border: 1px solid #ddd; padding: 8px;">Provision of data is optional and if you decide not to give consent to processing, you will not suffer any negative consequences regarding the existing or being formed contract.</td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>IV.</strong> - personal data, provided by you and/or acquired from third parties (excluding data of special categories), - contact data (email and telephone) - data acquired through questionnaires on needs, interests and preferences, for the purpose of analyzing aspects concerning, among others, economic situation, personal preferences, interests, habits, behavior, and to improve the offer of the Company itself and by the companies of the belonging group.</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Consent of the data subject (art. 6, par. 1, lett. a), GDPR)</td>
                        ...
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>V.</strong> Demographic data and data provided for example on the occasion of the mandatory completion by law of questionnaires relating to your risk profiles</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Compliance with legal obligations to which the data controller is subject (art. 6, par. 1, lett. c), GDPR)</td>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>Compliance with legal obligations incumbent on the Controller</strong> (e.g. regulatory obligations relating to the insurance sector, obligations for Website accessibility, etc.)</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">10 years or the different term provided by applicable law</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">The provision of personal data is implicit whenever the user browses the Website and/or requests to use the services offered by the Website.</td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>VI.</strong> Demographic and pre-contractual data, and any relevant data in the specific case</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Legitimate interest of Acrisure Re Italia S.r.l. and/or third parties to exercise the right of defense and protection of rights and/or interests of Acrisure Re Italia S.r.l. and/or third parties (art. 6, par. 1, lett. f), GDPR).</td>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>Establishment, exercise or defense of a right of Acrisure Re Italia S.r.l. or third parties</strong></td>
            ...
            <div class="privacy-section">
                ...
                <p>The processing of personal data for the purposes described above will be carried out by the internal staff specifically appointed by Acrisure Re Italia S.r.l. who will act on the basis of specific instructions provided by the Controller itself.</p>
                <p>Furthermore, personal data may also be communicated to the following subjects:</p>
                <ul>
                    <li>a) Insurance agents and subjects who process personal data for the purposes described above on behalf of Acrisure Re Italia S.r.l., specifically appointed as data processors pursuant to art. 28 GDPR (for example, IT service providers or Website developers);</li>
            ...
            <div class="privacy-section">
                ...
                <p>Without prejudice to what is provided for the processing of data carried out through cookies, for which please refer to the <a href="/eng/cookies-eng/cookiesRe-eng.php">relevant information</a>, the transfer of personal data to countries outside the European Economic Area ("EEA") or to international organizations is not envisaged.</p>
            ...
            <div class="privacy-section">
                ...
                <ul>
                    <li><strong>Right of access</strong>: right to obtain from the Controller confirmation as to whether or not personal data concerning him or her are being processed, and, where that is the case, access to the personal data and further information on origin, purpose, categories of processed data, recipients of communication and/or data transfer, etc;</li>
                    <li><strong>Right to rectification</strong>: right to obtain from the Controller without undue delay the rectification of inaccurate personal data, as well as the integration of incomplete personal data, also by providing a supplementary statement;</li>
                    <li><strong>Right to erasure</strong>: right to obtain from the Controller the erasure of personal data without undue delay in the case where:
                        <ul>
                            ...
                            <li>the personal data have to be erased for compliance with a legal obligation under Union or Member State law to which the controller is subject;</li>
                        </ul>
                    </li>
                    <li><strong>Right to object to processing</strong>: right to object at any time, on grounds relating to his or her particular situation, to processing of personal data pursuant to Article 6(1)(e) or (f), GDPR, including profiling based on those provisions;</li>
                    <li><strong>Right to restriction of processing</strong>: right to obtain from the Controller restriction of processing, in the cases where the accuracy of the personal data is contested (for the period necessary for the controller to verify the accuracy of such personal data), if the processing is unlawful and/or the data subject has objected to processing;</li>
                ...
                <p>To exercise these rights, make reports and/or request clarifications on the processing of personal data, data subjects can send an email to: <a href="mailto:acrisurereitalia@pec.it">acrisurereitalia@pec.it</a> or a registered letter to: Acrisure Re Italia S.r.l., Via Mazzini 3, 07100, Sassari.</p>
            </div>

            <div class="privacy-section">
                <h2>7) METHODS OF EXERCISING RIGHTS</h2>
                <p><strong>We also remind you that you have the right to lodge a complaint with a supervisory authority.</strong> In particular, without prejudice to any other administrative or judicial remedy, the data subject who considers that the processing concerning him or her violates the GDPR has the right to lodge a complaint with the supervisory authority of the Member State where he or she normally resides or works, or of the State where the alleged violation occurred. For Italy, the competent Authority is the Guarantor for the Protection of Personal Data.</p>
            </div>

            <div class="privacy-section">
                <h2>8) CHANGES AND UPDATES TO THIS INFORMATION</h2>
                <p>Also in consideration of future changes that may occur in the legislation on the protection of personal data, Acrisure Re Italia S.r.l. may integrate and/or update, in whole or in part, this information. It is understood that any change, integration or update will be communicated in accordance with current legislation, by means of publication on the website <a href="/eng/re-eng.php">Acrisure Re Italia S.r.l.</a></p>
            </div>
        </div>
    </section>
