...
<body>
    <header id="header">
        <div class="navbar">
            ...
            <nav class="language-switcher">
                <ul>
                    <li><a href="/singleNews/singleItalia.php" class="language-btn">IT</a></li>
    ...
    <article class="news-article">
        ...
        <div class="article-footer">
            ...
            <a href="../news-eng/newsItalia-eng.php" class="back-to-news"><i class="fas fa-arrow-left"></i> Back to news</a>
                ...
                <div class="related-grid">
                    ...
                    <article class="related-card">
                        ...
                        <div class="related-content">
                            ...
                            <a href="/eng/singleNews-eng/singleItalia-eng.php?id=<?php echo $related_id; ?>" class="related-link">Read article <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </article>
                    <?php 
                        endif;
