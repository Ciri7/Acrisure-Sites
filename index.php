...
<style>
    ...
    * {
    ...
    @media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) {
        .hero, .hero2, .leadership, .news-section {
    ...
    @media print {
        * {
        ...
        nav, .btn, .news-nav, .cookie-banner, .footer-newsletter button {
    ...
    <section id="gruppo" class="section gruppo">
        ...
        <div class="aziende-container">
            <div class="aziende-grid">
                ...
                <div class="azienda-card">
                    <div class="azienda-card-content">
                        <img src="/img/logoAltaBroker.png" alt="Acrisure Italia" class="azienda-logo">
