...
<head>
    ...
    <title>Acrisure Re Italia - Legal & Compliance</title>
        ...
        <div class="navbar">
            ...
            <nav class="language-switcher">
                <ul>
                    ...
                    <li><a href="/eng/legal-eng/legalRe-eng.php" class="language-btn">EN</a></li>
                </ul>
            </nav>
        </div>
    </header>
        ...
        <div class="legal-content">
            <div class="legal-section">
                ...
                <p>
                    ...
                    A tal fine, Acrisure Re Italia S.r.l., si è dotata di un sistema interno per la gestione delle segnalazioni, disciplinato dalla Procedura Whistleblowing, elaborata in collaborazione con le rappresentanze sindacali, ai sensi dell’art. 51 del D.lgs. 81/2015. Questa procedura stabilisce le modalità di ricezione e verifica delle segnalazioni, coinvolgendo attivamente la Società, i dipendenti e i soggetti terzi.
                ...
                <ul>
                    <li><a href="../DOCUMENTI/MODELLO 231/WB_Re_Italia.pdf" target="_blank">Procedura Whistleblowing</a></li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <footer>
        ...
        <div class="footer-legal-notice">
            <p>Acrisure Re Italia S.r.l. - Società con socio unico soggetta alla direzione e coordinamento di Acrisure S.r.l. - Cap.sociale € 120.000,00 i.v.
                ...
                I dati identificativi e di iscrizione sopra forniti possono essere verificati consultando il Registro Unico degli Intermediari (RUI) sul sito Ivass: <a href="https://ruipubblico.ivass.it/rui-pubblica/ng/#/home">www.ivass.it</a>.
