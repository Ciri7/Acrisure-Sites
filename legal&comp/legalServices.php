        ...
        <div class="navbar">
            ...
            <nav class="language-switcher">
                <ul>
                    ...
                    <li><a href="/eng/legal-eng/legalServices-eng.php" class="language-btn">EN</a></li>
                </ul>
            </nav>
        </div>
    </header>
        ...
        <div class="legal-content">
            ...
            <div class="legal-section">
                ...
                <p>
                    ...
                    A tal fine, Acrisure Services S.r.l. si è dotata di un sistema interno per la gestione delle segnalazioni, disciplinato dalla Procedura Whistleblowing, elaborata in collaborazione con le rappresentanze sindacali, ai sensi dell’art. 51 del D.lgs. 81/2015. Questa procedura stabilisce le modalità di ricezione e verifica delle segnalazioni, coinvolgendo attivamente la Società, i dipendenti e i soggetti terzi.
                ...
                <ul>
                    <li><a href="../DOCUMENTI/MODELLO 231/WB_Services.pdf" target="_blank">Procedura Whistleblowing</a></li>
                </ul>
            </div>
        </div>
    </section>
