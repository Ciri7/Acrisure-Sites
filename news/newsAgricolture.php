...
<head>
    ...
    <title>Acrisure Agricolture - News</title>
        ...
        <div class="navbar">
            ...
            <nav class="language-switcher">
                <ul>
                    ...
                    <li><a href="/eng/news-eng/newsAgricolture-eng.php" class="language-btn">EN</a></li>
                </ul>
            </nav>
        </div>
    </header>
        ...
        <div class="news-grid">
            ...
            <article class="news-card">
                ...
                <div class="news-content">
                    ...
                    <a href="/singleNews/singleAgricolture.php?id=1" class="news-link">Leggi tutto <i class="fas fa-arrow-right"></i></a>
                </div>
            </article>
            ...
            <article class="news-card">
                ...
                <div class="news-content">
                    ...
                    <a href="/singleNews/singleAgricolture.php?id=2" class="news-link">Leggi tutto <i class="fas fa-arrow-right"></i></a>
                </div>
            </article>
            ...
            <article class="news-card">
                ...
                <div class="news-content">
                    ...
                    <a href="/singleNews/singleAgricolture.php?id=3" class="news-link">Leggi tutto <i class="fas fa-arrow-right"></i></a>
                </div>
            </article>
            ...
            <article class="news-card">
                ...
                <div class="news-content">
                    ...
                    <a href="/singleNews/singleAgricolture.php?id=4" class="news-link">Leggi tutto <i class="fas fa-arrow-right"></i></a>
                </div>
            </article>
            ...
            <article class="news-card">
                ...
                <div class="news-content">
                    ...
                    <a href="/singleNews/singleAgricolture.php?id=5" class="news-link">Leggi tutto <i class="fas fa-arrow-right"></i></a>
                </div>
            </article>
            ...
            <article class="news-card">
                ...
                <div class="news-content">
                    ...
                    <a href="/singleNews/singleAgricolture.php?id=6" class="news-link">Leggi tutto <i class="fas fa-arrow-right"></i></a>
                </div>
            </article>
        </div>
