        ...
        <div class="navbar">
            ...
            <nav class="language-switcher">
                <ul>
                    ...
                    <li><a href="/eng/policy-eng/policyAgriservices-eng.php" class="language-btn">EN</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <section class="section">
        <div class="privacy-content">
            <div class="privacy-section">
                ...
                <h3>INTRODUZIONE</h3>
                <p>Ai sensi del Regolamento (UE) 2016/679 ("GDPR"), Acrisure Agriservices S.r.l. fornisce la presente informativa sul trattamento dei dati personali degli utenti che navigano sul sito web <a href="/agriservices.php">Acrisure Agriservices S.r.l.</a> e che forniscono i propri dati personali per fruire dei servizi ivi offerti.</p>
                ...
                <p>La presente informativa si applica a tutti gli utenti, tra cui visitatori registrati e non registrati, del nostro sito: <a href="/agriservices.php">Acrisure Agriservices S.r.l.</a>. Si invita l'utente a leggere attentamente la presente informativa. In caso di dubbi o domande l'utente potrà contattarci all'indirizzo: <a href="mailto:demetra@pec.demetra.it">demetra@pec.demetra.it</a></p>
            </div>

            <div class="privacy-section">
                <h2>1) TITOLARE DEL TRATTAMENTO E RESPONSABILE DELLA PROTEZIONE DEI DATI</h2>
                <p><strong>Titolare del Trattamento</strong> è Acrisure Agriservices S.r.l., Via Lovanio, 6 - 00198 Roma.</p>
            ...
            <div class="privacy-section">
                ...
                <p>Acrisure Agriservices S.r.l. tratterà i seguenti dati personali degli utenti:</p>
                ...
                <ul>
                    ...
                    <li>dati presenti nei messaggi inviati a Acrisure Agriservices S.r.l. per richiedere informazioni.</li>
                </ul>
            </div>
            ...
            <div class="privacy-section">
                ...
                <table style="width:100%; border-collapse: collapse; margin: 20px 0;">
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid #ddd; padding: 12px; vertical-align: top;">Si rinvia a quanto riportato nell'<a href="/cookies/cookiesAgriservices.php">informativa cookie</a>.</td>
                        <td style="border: 1px solid #ddd; padding: 12px; vertical-align: top;">Si rinvia a quanto riportato nell'<a href="/cookies/cookiesAgriservices.php">informativa cookie</a>.</td>
                    </tr>
                    <tr style="background-color: #f9f9f9;">
                        ...
                        <td style="border: 1px solid #ddd; padding: 12px; vertical-align: top;">Il mancato conferimento dei dati comporterà l'impossibilità per Acrisure Agriservices S.r.l. di erogare i servizi richiesti, ma non influirà sulla fruizione del Sito web da parte dell'utente.</td>
                    </tr>
                    <tr>
                    ...
                    <tr style="background-color: #f9f9f9;">
                        ...
                        <td style="border: 1px solid #ddd; padding: 12px; vertical-align: top;">Legittimo interesse di Acrisure Agriservices S.r.l. e/o di terzi ad esercitare il diritto di difesa e di tutela di diritti e/o interessi di Acrisure Agriservices S.r.l. e/o di terzi (art. 6, par. 1, lett. f), GDPR).</td>
                        <td style="border: 1px solid #ddd; padding: 12px; vertical-align: top;"><strong>Accertamento, esercizio o difesa di un diritto di Acrisure Agriservices S.r.l. o di terzi</strong></td>
            ...
            <div class="privacy-section">
                ...
                <p>Il trattamento dei dati personali per le finalità sopra illustrate sarà effettuato dal personale interno appositamente incaricato di Acrisure Agriservices S.r.l. che agirà sulla base di specifiche istruzioni fornite dal Titolare stesso.</p>
                <p>Inoltre, i dati personali potranno essere comunicati anche ai seguenti soggetti:</p>
                <ul>
                    <li>a) Agenti di assicurazione e soggetti che trattano i dati personali per le finalità sopra illustrate per conto di Acrisure Agriservices S.r.l., appositamente nominati responsabili del trattamento ai sensi dell'art. 28 GDPR (ad esempio, fornitori di servizi IT o sviluppatori del Sito web);</li>
            ...
            <div class="privacy-section">
                ...
                <p>Per esercitare tali diritti, effettuare segnalazioni e/o chiedere chiarimenti sul trattamento dei dati personali, gli interessati possono inviare una e-mail all'indirizzo: <a href="mailto:demetra@pec.demetra.it">demetra@pec.demetra.it</a> oppure una raccomandata all'indirizzo: Acrisure Agriservices S.r.l., Via Lovanio, 6 - 00198 Roma.</p>
            </div>
            ...
            <div class="privacy-section">
                ...
                <p>Anche in considerazione dei futuri cambiamenti che potranno intervenire sulla normativa in materia di protezione dei dati personali, Acrisure Agriservices S.r.l. potrà integrare e/o aggiornare, in tutto o in parte, la presente informativa. Resta inteso che qualunque modifica, integrazione o aggiornamento le sarà comunicato in conformità alla normativa vigente, a mezzo pubblicazione sul sito internet <a href="/agriservices.php">Acrisure Agriservices S.r.l.</a></p>
            </div>
        </div>
    </section>
