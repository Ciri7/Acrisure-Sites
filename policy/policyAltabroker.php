...
<head>
    ...
    <title>Alta Broker & Partners - Privacy Policy</title>
        ...
        <div class="navbar">
            ...
            <nav class="language-switcher">
                <ul>
                    ...
                    <li><a href="/eng/policy-eng/policyAltabroker-eng.php" class="language-btn">EN</a></li>
            </nav>
        </div>
    </header>
    ...
    <section class="section">
        <div class="privacy-content">
            <div class="privacy-section">
                ...
                <h3>INTRODUZIONE</h3>
                <p>Ai sensi del Regolamento (UE) 2016/679 ("GDPR"), Alta Broker & Partners S.r.l. fornisce la presente informativa sul trattamento dei dati personali degli utenti che navigano sul sito web <a href="/altabroker.php">Alta Broker & Partners S.r.l.</a> e che forniscono i propri dati personali per fruire dei servizi ivi offerti.</p>
                ...
                <p>La presente informativa si applica a tutti gli utenti, tra cui visitatori registrati e non registrati, del nostro sito: <a href="/altabroker.php">Alta Broker & Partners S.r.l.</a>. Si invita l'utente a leggere attentamente la presente informativa. In caso di dubbi o domande l'utente potrà contattarci all'indirizzo: <a href="mailto:altabrokerandpartners@pec.it">altabrokerandpartners@pec.it</a></p>
            </div>

            <div class="privacy-section">
                <h2>1) TITOLARE DEL TRATTAMENTO E RESPONSABILE DELLA PROTEZIONE DEI DATI</h2>
                <p><strong>Titolare del Trattamento</strong> è Alta Broker & Partners S.r.l., Via Assarotti, 5/1 - 16122 Genova</p>
            ...
            <div class="privacy-section">
                ...
                <p>Alta Broker & Partners S.r.l. tratterà i seguenti dati personali degli utenti:</p>
                ...
                <ul>
                    ...
                    <li>dati presenti nei messaggi inviati a Alta Broker & Partners S.r.l. per richiedere informazioni.</li>
                </ul>
            </div>
            ...
            <div class="privacy-section">
                ...
                <table style="width:100%; border-collapse: collapse; margin: 20px 0;">
                    ...
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;"><strong>I.</strong> Dati di navigazione cookie tecnici (strettamente necessari) e cookie analitici</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">art. 130 D.lgs. 196/2003</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;"><strong>Erogazione del contenuto del Sito web e analisi statistiche aggregate</strong></td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">Si rinvia a quanto riportato nell'<a href="/cookies/cookiesAltabroker.php">informativa cookie</a></td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">Si rinvia a quanto riportato nell'<a href="/cookies/cookiesAltabroker.php">informativa cookie</a></td>
                    </tr>
                    <tr style="background-color: #f9f9f9;">
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;"><strong>II.</strong> Dati anagrafici e di contatto Dati attinenti al bene che si intende assicurare</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">Esecuzione di un contratto o di misure precontrattuali richieste dall'interessato (art. 6, par. 1, lett. b), GDPR)</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;"><strong>Erogazione dei servizi di "Richiesta di informazioni" e "richiesta di assistenza" nell'area "contattaci" Erogazione dei servizi di "consulenza"</strong></td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">2 anni dalla richiesta del servizio e dalla richiesta di preventivo (per i prospect) 10 anni dalla cessazione del rapporto contrattuale (per i clienti)</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">Il mancato conferimento dei dati comporterà l'impossibilità per Alta Broker & Partners S.r.l. di erogare i servizi richiesti, ma non influirà sulla fruizione del Sito web da parte dell'utente.</td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;"><strong>III.</strong> Dati personali comuni forniti dall'interessato, compresi quelli inerenti recapiti e contatti.</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">Consenso dell'interessato (art. 6, par. 1, lett. a), GDPR)</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;"><strong>MARKETING</strong> (a titolo esemplificativo e non esaustivo: invio di comunicazioni promozionali, vendita diretta, targeting e re-targeting, compimento di ricerche di mercato mediante modalità automatizzate e digitali ad es. SMS, Posta elettronica, App di messaggistica istantanea...)</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">24 mesi dalla richiesta di preventivo o dalla richiesta di consulenza ovvero fino alla revoca del consenso dell'interessato se precedente.</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">Il conferimento dei dati è facoltativo e nel caso in cui decida di non prestare il consenso al trattamento lei non subirà alcuna conseguenza negativa riguardo al contratto in essere ovvero in corso di costituzione.</td>
                    </tr>
                    <tr style="background-color: #f9f9f9;">
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;"><strong>IV.</strong> - dati personali, da lei forniti e/o acquisiti da terzi (con esclusione dei dati di categorie particolari), - dati di contatto (mail e telefono) - dati acquisiti tramite questionari su bisogni, interessi e preferenze, allo scopo di analizzare aspetti riguardanti, tra gli altri, situazione economica, preferenze personali, interessi, abitudini, comportamento, e per migliorare l'offerta della Società stessa e dalle Società del gruppo di appartenenza.</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">Consenso dell'interessato (art. 6, par. 1, lett. a), GDPR)</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;"><strong>PROFILAZIONE</strong> (trattamento automatizzato di dati personali per analizzare o prevedere aspetti riguardanti la situazione economica, le preferenze personali, gli interessi, il comportamento ai fini dell'attività di marketing)</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">12 mesi dalla richiesta di preventivo o dalla richiesta di consulenza ovvero fino alla revoca del consenso dell'interessato se precedente.</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">Il conferimento dei dati è facoltativo e nel caso in cui decida di non prestare il consenso al trattamento lei non subirà alcuna conseguenza negativa riguardo al contratto in essere ovvero in corso di costituzione.</td>
                    </tr>
                    <tr>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;"><strong>V.</strong> Dati anagrafici e dati forniti ad esempio in occasione della compilazione obbligatoria per legge di questionari relativi ai suoi profili di rischio</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">Adempimento di obblighi legali cui è soggetto il titolare del trattamento (art. 6, par. 1, lett. c), GDPR)</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;"><strong>Adempimento di obblighi legali gravanti sul Titolare</strong> (es. obblighi regolamentari relativi al settore assicurativo, obblighi per l'accessibilità del Sito web, etc.)</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">10 anni oppure il diverso termine previsto dalle norme di legge applicabili</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">Il conferimento dei dati personali è implicito ogniqualvolta l'utente navighi sul Sito web e/o richieda di usufruire dei servizi offerti dal Sito web.</td>
                    </tr>
                    <tr style="background-color: #f9f9f9;">
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;"><strong>VI.</strong> Dati anagrafici e precontrattuali, e qualsiasi dato rilevante nel caso concreto</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">Legittimo interesse di Alta Broker & Partners S.r.l. e/o di terzi ad esercitare il diritto di difesa e di tutela di diritti e/o interessi di Alta Broker & Partners S.r.l. e/o di terzi (art. 6, par. 1, lett. f), GDPR).</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;"><strong>Accertamento, esercizio o difesa di un diritto di Alta Broker & Partners S.r.l. o di terzi</strong></td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">Per tutto il tempo necessario alla definizione dell'eventuale situazione contenziosa o precontenziosa fino al definitivo passaggio in giudicato o decorso dei tempi di prescrizione.</td>
                        <td style="border: 1px solid #ddd; padding: 8px; vertical-align: top;">Il conferimento dei dati personali è implicito ogniqualvolta l'utente navighi sul Sito web e/o richieda di usufruire dei servizi offerti dal Sito web.</td>
                    </tr>
                </table>
            </div>
            ...
            <div class="privacy-section">
                ...
                <p>Il trattamento dei dati personali per le finalità sopra illustrate sarà effettuato dal personale interno appositamente incaricato di Alta Broker & Partners S.r.l. che agirà sulla base di specifiche istruzioni fornite dal Titolare stesso.</p>
                <p>Inoltre, i dati personali potranno essere comunicati anche ai seguenti soggetti:</p>
                <ul>
                    <li>a) Agenti di assicurazione e soggetti che trattano i dati personali per le finalità sopra illustrate per conto di Alta Broker & Partners S.r.l., appositamente nominati responsabili del trattamento ai sensi dell'art. 28 GDPR (ad esempio, fornitori di servizi IT o sviluppatori del Sito web);</li>
            ...
            <div class="privacy-section">
                ...
                <p>Per esercitare tali diritti, effettuare segnalazioni e/o chiedere chiarimenti sul trattamento dei dati personali, gli interessati possono inviare una e-mail all'indirizzo: <a href="mailto:altabrokerandpartners@pec.it">altabrokerandpartners@pec.it</a> oppure una raccomandata all'indirizzo: Alta Broker & Partners S.r.l., Via Assarotti, 5/1 - 16122 Genova.</p>
            </div>
            ...
            <div class="privacy-section">
                ...
                <p>Anche in considerazione dei futuri cambiamenti che potranno intervenire sulla normativa in materia di protezione dei dati personali, Alta Broker & Partners S.r.l. potrà integrare e/o aggiornare, in tutto o in parte, la presente informativa. Resta inteso che qualunque modifica, integrazione o aggiornamento le sarà comunicato in conformità alla normativa vigente, a mezzo pubblicazione sul sito internet <a href="/altabroker.php">Alta Broker & Partners S.r.l.</a></p>
            </div>
        </div>
    </section>
