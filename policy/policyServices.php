    ...
    <section class="section">
        <div class="privacy-content">
            ...
            <div class="privacy-section">
                ...
                <p><strong>Titolare del Trattamento</strong> è Acrisure Services S.r.l., Via Mazzini 3, 07100, Sassari</p>
            ...
            <div class="privacy-section">
                ...
                <p>Acrisure Services S.r.l. tratterà i seguenti dati personali degli utenti:</p>
                ...
                <ul>
                    ...
                    <li>altri dati che potranno essere richiesti in futuro attraverso nuove sezioni o servizi del Sito web (a titolo meramente esemplificativo e non esaustivo ad esempio, iscrizioni a newsletter, registrazioni ad area riservate o analoghi strumenti di interazione);</li>
                    <li>dati presenti nei messaggi inviati a Acrisure Services S.r.l. per richiedere informazioni.</li>
                </ul>
            </div>
                ...
                <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="border: 1px solid #ddd; padding: 8px;">Si rinvia a quanto riportato nell'<a href="/cookies/cookiesServices.php">informativa cookie</a>.</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Si rinvia a quanto riportato nell'<a href="/cookies/cookiesServices.php">informativa cookie</a>.</td>
                        </tr>
                        <tr>
                            ...
                            <td style="border: 1px solid #ddd; padding: 8px;">Il mancato conferimento dei dati comporterà l'impossibilità per Acrisure Services S.r.l. di erogare i servizi richiesti, ma non influirà sulla fruizione del Sito web da parte dell'utente.</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid #ddd; padding: 8px;">Legittimo interesse di Acrisure Services S.r.l. e/o di terzi ad esercitare il diritto di difesa e di tutela di diritti e/o interessi di Acrisure Services S.r.l. e/o di terzi (art. 6, par. 1, lett. f), GDPR).</td>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>Accertamento, esercizio o difesa di un diritto di Acrisure Services S.r.l. o di terzi</strong></td>
            ...
            <div class="privacy-section">
                ...
                <p>Il trattamento dei dati personali per le finalità sopra illustrate sarà effettuato dal personale interno appositamente incaricato di Acrisure Services S.r.l. che agirà sulla base di specifiche istruzioni fornite dal Titolare stesso.</p>
                <p>Inoltre, i dati personali potranno essere comunicati anche ai seguenti soggetti:</p>
                <ul>
                    <li>a) Agenti di assicurazione e soggetti che trattano i dati personali per le finalità sopra illustrate per conto di Acrisure Services S.r.l., appositamente nominati responsabili del trattamento ai sensi dell'art. 28 GDPR (ad esempio, fornitori di servizi IT o sviluppatori del Sito web);</li>
            ...
            <div class="privacy-section">
                ...
                <ul>
                    ...
                    <li><strong>Diritto alla portabilità dei dati</strong>: diritto di recevere in un formato strutturato, di uso comune e leggibile da dispositivo automatico i dati personali e di trasmettere tali dati ad altro titolare del trattamento, solo per i casi in cui il trattamento sia basato sul consenso e per i soli dati trattati tramite strumenti elettronici.</li>
                </ul>
                <p>Per esercitare tali diritti, effettuare segnalazioni e/o chiedere chiarimenti sul trattamento dei dati personali, gli interessati possono inviare una e-mail all'indirizzo: <a href="mailto:acrisureservices@pec.acrisureservices.com">acrisureservices@pec.acrisureservices.com</a> oppure una raccomandata all'indirizzo: Acrisure Services S.r.l., Via Mazzini 3, 07100, Sassari.</p>
            </div>
            ...
            <div class="privacy-section">
                ...
                <p>Anche in considerazione dei futuri cambiamenti che potranno intervenire sulla normativa in materia di protezione dei dati personali, Acrisure Services S.r.l. potrà integrare e/o aggiornare, in tutto o in parte, la presente informativa. Resta inteso che qualunque modifica, integrazione o aggiornamento le sarà comunicato in conformità alla normativa vigente, a mezzo pubblicazione sul sito internet <a href="/services.php">Acrisure Services S.r.l.</a></p>
            </div>
        </div>
    </section>
