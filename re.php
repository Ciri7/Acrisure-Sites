...
<body>
            ...
            <div class="services-container">
                <div class="service-card">
                    ...
                    <div class="service-content">
                        ...
                        <ul class="service-features">
                            ...
                            <li>Trasferimento del singolo rischio</li>
                        </ul>
                ...
                <div class="service-card">
                    ...
                    <div class="service-content">
                        ...
                        <ul class="service-features">
                            <li>Analisi esposizioni catastrofali</li>
                            <li>Utilizzo modelli catastrofali</li>
                            <li>Calcolo sinistro massimo probabile</li>
                        </ul>
            ...
            <form id="contactForm">
                ...
                <div class="form-footer">
                    <div class="form-note">
                        ...
                        <p>Leggi la nostra <a href="/policy/policyRe.php">Privacy Policy</a></p>
                    </div>
    ...
    <footer>
        ...
        <div class="footer-legal-notice">
            <p>Acrisure Re Italia S.r.l. - Società con socio unico soggetta alla direzione e coordinamento di Acrisure S.r.l.- Cap.sociale € 120.000,00 i.v-RUI: B000729790.<br>
            Società partecipante al Gruppo IVA Acrisure P.IVA 13147890969- Cod. Fiscale e n. iscr.al registro Imprese di Sassari n.02942110905 REA SS-217191</p>
        </div>
    </footer>

    <!-- Cookie banner -->
    <div id="cookie-banner" class="cookie-banner">
        <p>Utilizziamo cookie per migliorare la tua esperienza. <a href="/cookies/cookiesRe.php">Maggiori informazioni</a></p>
