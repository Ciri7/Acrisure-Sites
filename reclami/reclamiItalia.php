    ...
    <section class="section">
        <div class="privacy-content">
            <div class="privacy-section">
                ...
                <p><strong>Gentile cliente,</strong>ferma la possibilità di rivolgerti all’Autorità Giudiziaria, hai la facoltà di inoltrare reclamo per iscritto all’impresa preponente ai recapiti indicati nel DIP aggiuntivo o all’intermediario. Per i reclami all’intermediario può utilizzare gli indirizzi mail dedicati reclami@acrisureitalia.com, ovvero tramite PEC all’indirizzo acrisurespa@pec.acrisureitalia.com ed infine con raccomandata A/R indirizzata alla Funzione Reclami - Acrisure Italia S.p.A., via Mazzini n. 3, 07100 - Sassari. 
                    Anche al fine di facilitare il riscontro, il reclamo deve contenere l’indicazione di: l’oggetto del reclamo e descrizione delle circostanze su cui lo stesso verte; la qualità del reclamante (ad es. Contraente, Assicurato, Danneggiato, Beneficiario, Associazione di Consumatore, o altro); l’indirizzo di residenza; il recapito telefonico e/o indirizzo e-mail; il numero della polizza; il nominativo del Contraente; il numero e la data dell’eventuale sinistro a cui fai riferimento; se il reclamo ha ad oggetto il comportamento dei nostri dipendenti e/o collaboratori oppure riguarda i prodotti/servizi da noi offerti; qualsiasi altra informazione che ritieni utile per aiutarci a comprendere il problema.
                    Qualora non dovessi essere soddisfatto dell’esito del reclamo o in caso di assenza di riscontro da parte dell’intermediario o dell’impresa entro il termine di legge previsto in 45 giorni, hai altresì la facoltà di rivolgersi all’IVASS tramite l’apposito form previsto sul sito web www.ivass.it inviando il reclamo ai seguenti recapiti: via PEC all’indirizzo tutela.consumatore@pec.ivass.it, via fax al numero 06.42133206 ovvero tramite posta ordinaria “IVASS Servizio Tutela del Consumatore” - Via del Quirinale, 21 00187 Roma. 
                    Ed ancora hai la facoltà di avvalerti di altri eventuali sistemi alternativi di risoluzione delle controversie previsti dalla normativa vigente, sempre secondo quanto indicato nel DIP aggiuntivo.
                    Da ultimo, hai altresì la facoltà di rivolgersi al Fondo di Garanzia per l’attività dei mediatori di assicurazione e riassicurazione istituito presso la Consap, Via Yser 14,00198 Roma, telefono 06.857961 per chiedere, laddove ne esistano i presupposti ed il diritto a farlo, il risarcimento del danno patrimoniale loro causato dall’esercizio dell’attività di intermediazione, che non sia stato risarcito dall’intermediario stesso o non sia stato indennizzato attraverso il contratto di assicurazione della Responsabilità Civile che copre i danni arrecati ai contraenti da negligenze ed errori professionali dell’intermediario o da negligenze, errori professionali ed infedeltà dei dipendenti, dei collaboratori o delle persone del cui operato l’intermediario deve rispondere a norma di legge.
                </p>
            </div>
        </div>
    </section>
