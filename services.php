...
<head>
    ...
    <title>Acrisure Services S.r.l.</title>
    ...
    <section id="news" class="section news-section">
        ...
        <div class="news-wrapper">
            ...
            <div class="news-container">
                <div class="news-card" data-index="0" onclick="window.location.href='singleNews/singleServices.php?id=1'">
                ...
                <div class="news-card" data-index="1" onclick="window.location.href='singleNews/singleServices.php?id=2'">
                    <div class="news-image">
                ...
                <div class="news-card" data-index="2" onclick="window.location.href='singleNews/singleServices.php?id=3'">
                    <div class="news-image">
                ...
                <div class="news-card" data-index="3" onclick="window.location.href='singleNews/singleServices.php?id=4'">
                    <div class="news-image">
                ...
                <div class="news-card" data-index="4" onclick="window.location.href='singleNews/singleServices.php?id=5'">
                    <div class="news-image">
