...
<body>
        ...
        <div class="navbar">
            ...
            <nav class="language-switcher">
                <ul>
                    ...
                    <li><a href="/eng/singleNews-eng/singleAgriservices-eng.php" class="language-btn">EN</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <article class="news-article">
        ...
        <div class="article-footer">
            ...
            <a href="../news/newsAgriservices.php" class="back-to-news"><i class="fas fa-arrow-left"></i> Torna alle news</a>
